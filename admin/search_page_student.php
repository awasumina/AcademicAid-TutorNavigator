...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search" placeholder="Search Student..." class="box">
...
<!-- <h1>Teacher List</h1> -->
   ...
   <?php
      if(isset($_POST['submit'])){
         ...
         $result = mysqli_query($conn, "SELECT * FROM `student` WHERE cfn LIKE '%{$search_item}%'") or die('query failed');
