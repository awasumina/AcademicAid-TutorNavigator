...
if(isset($_POST['login'])) {	
    $name = $_POST['username'];
    echo "Username entered: " . $name; // Debug statement
    $password = $_POST['password'];
    echo "Username entered: " . $password; // Debug statement
    ...
    if($result) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            if ('admin' == $password && 'admin' == $name) {
                ...
                header('location: ../admin/admindashboard.php?success=true');
            } else {
                ...
                <div class="loginform">
                    <form action="" method="post">
                        ...
                        <div class="icons">
                            ...
                            <div class="iconn">
                                <div class="icon">
                                    <a href="../html/loginforteacher.php"><i class="fa-solid fa-user-gear" style="margin-left: 35px;"></i></a>
                                </div>
                                <div class="icontext">
